...
Lista* init(int, Lista*); 
// crea una lista con un nuovo nodo iniziale 
// con campo info uguale a data e collegata in testa ad una 
// lista next (next può essere anche NULL)
